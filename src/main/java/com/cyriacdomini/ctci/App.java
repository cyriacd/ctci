...
import com.cyriacdomini.ctci.leetcode.BoldString;
...
public class App {
    public static void main(String[] args){
        ...
        System.out.println(BoldString.addBoldTag("aaabbcc", new String[]{"aaa","aab","bc"}));
        System.out.println(BoldString.addBoldTag("abcxyz123", new String[]{"abc","123"}));
    }
}